...
class LocaleTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testLoadBadPath()
    {
       ...
       $this->expectExceptionMessage('Path to locales does not exist');
    ...
    {
       $this->expectException(\Exception::class);
       $this->expectExceptionMessage('The plural form must be an array of 3 elements.');
    ...
    {
       $this->expectException(\Exception::class);
       $this->expectExceptionMessage('Each form must be one of singular or plural');
